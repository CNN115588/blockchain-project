...
},
{
    ...
    details: {
        transportMode: 'Standard Van',
        packagingType: 'Crate or Sack',
        verifiedByInspector: true,
...
},
{
    ...
    details: {
        inspectionNotes: 'Ventilation breakdown for 3 hours',
...
},
{
    ...
    {
    eventType: 'TRANSPORT',
    actorId: 'logistics_NGR_008',
    productId: 'GARLIC_BATCH_004',
    location: 'En route to Ibadan Market Row 5',
    details: {
        transportMode: 'Standard Van',
        packagingType: 'Crate or Sack',
        verifiedByInspector: true,
        vehicleId: 'MINI_TRUCK_04',
        departureTime: '2025-06-24T08:00:00Z',
        arrivalTime: '2025-06-24T12:30:00Z',
        delayHours: 1,
        delayReason: 'Minor tire burst',
        weatherCondition: 'Hot and dry with occasional dust',
        packagingType: 'Net Bag',
        currentTempCelsius: 34,
        currentHumidityPercent: 32,
        estimatedSpoilagePercent: 6,
        thresholds: { minTemp: 10, maxTemp: 25, minHumidity: 40, maxHumidity: 60 },
    }
},
...
},
{
    ...
    {
    eventType: 'WAREHOUSE_RECEIPT',
    actorId: 'warehouse_Lagos_002',
    productId: 'FROZEN_TILAPIA_005',
    location: 'Lagos Cold Chain Warehouse',
    details: {
        transportMode: 'Standard Van',
        packagingType: 'Crate or Sack',
        verifiedByInspector: true,
        receiptTime: '2025-07-02T18:00:00Z',
        storageSection: 'Frozen Zone A2',
        currentTempCelsius: -18,
        currentHumidityPercent: 70,
        weatherCondition: 'Power-stable refrigeration',
        estimatedSpoilagePercent: 0,
        thresholds: { minTemp: -20, maxTemp: -10, minHumidity: 50, maxHumidity: 80 },
...

{
    ...
    actorId: 'logistics_NGR_008',
    productId: 'FROZEN_TILAPIA_005',
    location: 'En route to Lekki Fish Market',
    details: {
        transportMode: 'Standard Van',
        packagingType: 'Crate or Sack',
        verifiedByInspector: true,
        vehicleId: 'FISH_VAN_302',
        departureTime: '2025-07-03T07:00:00Z',
        arrivalTime: '2025-07-03T08:30:00Z',
        delayHours: 0,
        delayReason: 'On schedule',
        weatherCondition: 'Refrigerated transport, no external exposure',
        currentTempCelsius: -16,
        currentHumidityPercent: 65,
        estimatedSpoilagePercent: 3,
        thresholds: { minTemp: -20, maxTemp: -10, minHumidity: 50, maxHumidity: 80 },
